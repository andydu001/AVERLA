...
public class Menu1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sch.setQueryHint("Search Averla");
        ...
        sch.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                if ( toStr.equals("afr") || toStr.equals("afri") || toStr.equals("africa") || toStr.equals("african")|| toStr.equals("a") || toStr.equals("af")) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                      ...
                      //Data set observer
                        AlphabetIndexer alphabetIndexer = new AlphabetIndexer(cursor,4 , "ABCDEFG");

                        //The Observable
                        DataSetObservable dataSetObservable = new DataSetObservable();

                        dataSetObservable.registerObserver(alphabetIndexer);
            ...
            public boolean onQueryTextChange(String s) {
                ...
                t6.setText(cursor.getString( 4));
                // autoCompleteTextView.setDropDownAnchor(Ancho);
                // t1.setText("     ");
                return true;
            }
        });
 ...
 */
    public static void Autom(AutoCompleteTextView autoCompleteTextView){
        //   autoCompleteTextView.

        //  autofillService.onFillRequest(FillRequest.CREATOR.createFromParcel(Parcel.obtain()), new CancellationSignal(),  );
    /*    autofillManager.commit();
        autofillManager.notifyViewClicked(view);
        Log.println(Log.WARN,"TAG", "Is it r fight "+autofillManager.getUserData().getId());*/
